...
class AttackEval:
    ...
    def eval(self, dataset: Iterable[Dict[str, Any]], total_len : Optional[int] = None, visualize : bool = False, progress_bar : bool = True, num_workers : int = 0, chunk_size : Optional[int] = None):
        """
