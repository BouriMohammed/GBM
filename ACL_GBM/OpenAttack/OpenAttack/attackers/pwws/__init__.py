...
from ...attack_assist.substitute.word import GloveSubstitute, get_default_substitute
...
class PWWSAttacker(ClassificationAttacker):
    ...
    def __init__(self,
            ...
            substitute : Optional[GloveSubstitute] = None,
            token_unk : str = "<UNK>",
        ...
        Args:
            ...
            substitute: A substitute that will be used during the attack procedure. Must be an instance of :py:class:`.GloveSubstitute`
